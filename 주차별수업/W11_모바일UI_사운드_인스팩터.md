...
> 본 수업 문서: **[W11 모바일 UI·사운드](W11_모바일UI_사운드.md)** · 같은 형식: [주인공](<W02_플레이어_캐릭터2(인스팩터).md>) · [HUD·메뉴](W06_플레이HUD_메뉴_인스팩터.md)
...
> **소리가 몇 번째 그림에서 나는지**는 별도 항목입니다 - `Attack 1 Swing Frame` 등. [주인공 편 8번](<W02_플레이어_캐릭터2(인스팩터).md>) 참고. **프레임 개수를 바꿨다면 이 숫자도 확인하세요.**
