...
**이 수업은 교육 목적의 실습이고 출시나 상업적 이용이 아닙니다.** 그래서 **인터넷의 무료 음원은 물론, 여러분이 좋아하는 기존 음악을 넣어도 수업 안에서는 문제가 되지 않습니다.**

**다만 두 가지는 기억해두세요.**

- **출처는 크레딧 팝업(`popup_credits.png`)에 적어주세요.** 과제 요구사항이자 실무에서 반드시 하는 일입니다. AI를 썼다면 어떤 도구를 썼는지도요
- **빌드를 밖으로 내보낼 때는 이야기가 달라집니다.** 수업에서 확인하는 것과, 그 게임을 친구에게 보내거나 **포트폴리오로 공개하는 것**은 다릅니다

> **포트폴리오로 쓸 생각이 조금이라도 있다면 처음부터 자유이용 음원으로 만드세요.** 나중에 소리만 갈아 끼우려면 파일명·길이·타이밍을 전부 다시 맞춰야 합니다. **위 사이트들만으로도 충분히 좋은 소리를 구할 수 있습니다.**
