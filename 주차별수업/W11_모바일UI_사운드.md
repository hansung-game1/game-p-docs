...
### ▶ [07. 사운드 구하기](../기본설명/07_사운드_구하기.md) 에 정리되어 있습니다

무료 사이트 목록, AI 생성 도구, **브라우저에서 효과음을 직접 만드는 방법**까지 그쪽에 있습니다. 여기서는 요점만 적습니다.

| 방법 | 대표 |
|---|---|
| **직접 만들기** ★ | **ChipTone** · **jsfxr** — 브라우저에서 버튼 한 번에 게임 효과음 생성. 설치·로그인·결제 없음 |
| 무료 내려받기 | **Pixabay** · **Mixkit**(표기 불필요) · Kenney · freesound |
| AI 생성 | Suno · Udio · **ElevenLabs**(효과음) |
| 직접 녹음 | 목소리·손뼉·종이 구기는 소리도 가공하면 쓸 만합니다 |

받은 소리는 **Audacity**(무료)로 앞뒤를 잘라내면 훨씬 나아집니다.

### 저작권 - 이 수업에서는

**이 수업은 교육 목적의 실습이고 출시나 상업적 이용이 아닙니다.** 그래서 **무료 음원은 물론, 여러분이 좋아하는 기존 음악을 넣어도 수업 안에서는 문제가 되지 않습니다.**

**다만 선을 하나만 기억하세요.**

| | |
|---|---|
| **괜찮은 것** | 수업 안에서 확인 · 과제 제출 · 친구들끼리 돌려 해보기 |
| **안 되는 것** | **인터넷 공개** · 출시 · 상업적 이용 — **저작권법 위반입니다** |

**이 수업 결과물의 공유 범위는 교수와 우리 수업 학생들입니다.** 그 안에서는 마음 놓고 만드세요. 조심할 것은 **본인이 제어할 수 없는 상황으로 퍼져나가는 것**입니다.

- **출처는 크레딧 팝업(`popup_credits.png`)에 적어주세요.** 과제 요구사항이자 실무에서 반드시 하는 일입니다. AI를 썼다면 어떤 도구를 썼는지도요
- **포트폴리오로 쓴다면** 출처와 의도를 분명히 밝히고, **보는 사람이 나와 받아보는 이(기업·담당자)뿐이도록** 하세요
- **나중에 출시를 생각한다면** 그때는 직접 만들거나 저작권에 위배되지 않는 음원으로 채워야 합니다

> **가능하면 처음부터 자유이용 음원으로 만드세요.** 나중에 소리만 갈아 끼우려면 파일명·길이·타이밍을 전부 다시 맞춰야 합니다. **자세한 것은 [07. 사운드 구하기](../기본설명/07_사운드_구하기.md)의 1번**에 있습니다.
...
네이버 카페 업로드 - 제목 `2D게임제작_11주차_123456홍길동`
